...
namespace SimplCommerce.Module.PurchaseForm.Areas.PurchaseForm.Components
{
    public class PurchaseFormsViewComponent : ViewComponent
    {
        //private readonly IRepository<NongMinGo> _categoryRepository;
        //private readonly IContentLocalizationService _contentLocalizationService;

        public PurchaseFormsViewComponent()
        {
